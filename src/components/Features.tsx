  ...
  const features = [
    {
      ...
      description: "Explore histórias antigas e lendas dos povos nórdicos, transmitidas através dos séculos."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      title: "Cultura Real",
      description: "Descubra a verdadeira história e cultura dos povos nórdicos, além das lendas."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      title: "Jogos Vikings",
      description: "Experimente a emoção dos mundos nórdicos através de jogos cuidadosamente selecionados."
    }
  ];
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl font-mjolnir text-red-300">Descubra o Mundo Nórdico</h2>
